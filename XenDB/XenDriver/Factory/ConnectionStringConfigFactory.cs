...
namespace XenDB.XenDriver.Factory{
    public class ConnectionStringConfigFactory {
        ...
        {
            return new JsonIO<ConnectionStringConfig>()
                .loadObject("F:/Repository/XenSoftDevTools/XenDB/XenDriver/ConnectionThreadManager/ConnectionStringConfig/ConnectionStringConfig.json");
        }
